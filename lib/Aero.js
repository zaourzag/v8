...
// Extensions require updating for Discord.js v14 (Structures.extend removed)
// require('./extensions');
// Settings schema needs to be reimplemented for Sapphire
// require('./settings');
...
class Aero extends SapphireClient {
	...
	async login(token) {
		...
		const { stage } = require('../config/aero');
		const db = {
			production: 'aero',
