...
Client.defaultGuildSchema
	...
	.add('social', folder => folder
		...
		.add('roles', 'any', { array: true, default: [] })
	)
	...
	.add('mod', folder => folder
		...
		.add('heuristics', 'Boolean')
		.add('mentionThreshold', 'Integer', { default: 5 })
		.add('similarityThreshold', 'Integer', { default: 100 })
		...
		.add('shield', 'Boolean', { default: true })
		.add('censor', 'String', { array: true, default: [] })
	)
	...
	.add('persist', 'Boolean', { default: true })
	.add('persistBlacklist', 'Role', { array: true, default: [] });
...
Client.defaultUserSchema
	...
	.add('lastDataTimestamp', 'Integer', { default: 0 })
	.add('lastDataPurgeTimestamp', 'Integer', { default: 0 })
