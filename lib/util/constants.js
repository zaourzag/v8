...
module.exports = {
	...
	userInfo: {
		...
		reasons: {
			DM_ADS: 'unsolicited advertising in direct messages',
			HARASSMENT: 'severe targeted harassment of a user or group',
			SCAMS: 'attempting to phish or scam users',
			IMPERSONATION: 'impersonating a user or brand with fraudulous intent'
		}
	},
