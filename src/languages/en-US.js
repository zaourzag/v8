...
const { success, loading, trusted, banned, nodata, perms: { granted, unspecified }, covid: { cases, recoveries, deaths, tests } } = require('../../lib/util/constants').emojis;
...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_INFO_USER_SENTINEL: `${trusted} ${bold`Verified`} via Aero Sentinel (legacy)`,
			...
			COMMAND_SHIELD_ENABLED: `${success} **Enabled** Aero Shield. Known bad users will be automatically banned.`,
			COMMAND_SHIELD_DISABLED: `${banned} **Disabled** Aero Shield. Known bad users will no longer be banned.`,
