...
const ICON = {
	...
	CAW: {
		...
		BAR: {
			XI: '<:caw_bar_xi:1250146059884298313>',
			II: '<:caw_bar_ii:1250146057376108614>',
			IX: '<:caw_bar_ix:1250146056336052357>',
			IO: '<:caw_bar_io:1250146054842744882>',
			XO: '<:caw_bar_xo:1250146058470817792>',
			OO: '<:caw_bar_oo:1250146051919183953>',
			OX: '<:caw_bar_ox:1250146053257429072>',
		}
	}
};
...
module.exports = {
	emojis: {
		...
		progress: {
			start_1: ICON.CAW.BAR.XI,
			start_0: ICON.CAW.BAR.XO,
			end_1: ICON.CAW.BAR.IX,
			end_0: ICON.CAW.BAR.OX,
			line_1: ICON.CAW.BAR.II,
			line_0: ICON.CAW.BAR.OO,
			swap: ICON.CAW.BAR.IO,
		}
	},
